...
public class RandevuVeritabani {
    private static final String DATABASE_ISIM = "Hastane2";
    ...
    public RandevuVeritabani(Context c) {
        this.con = c;
    }
    public RandevuVeritabani connectionOpen() throws SQLException {
    ...
    //Randevu Kayıt
    public void randevuAdd(String hastatc,String doktor,String brans,String tarih,String saat){
    ...
    //Randevu Silme
    public void randevuDelete (String id) {
        veritabanim.delete("randevular","id=?",new String[]{id});
    }

    //Randevu Liste
    public List<String> randevuList(){
    ...
    //Randevu Arama
    public List<String> randevuSearch(String hastatc){
        List<String> veriler = new ArrayList<String>();
        veritabanim  = veritabanihelper.getReadableDatabase();
        try {
    ...
    //Randevu Getir
    public ArrayList<HashMap<String, String>> randevuBring(String hastatc){
        veritabanim = veritabanihelper.getReadableDatabase();
        String selectQuery = "SELECT * FROM " + DATABASE_TABLO + " WHERE hastatc="+hastatc;
        Cursor cursor = veritabanim.rawQuery(selectQuery, null);
    ...
    //Randevu Güncelle
    public void randevuUpdate(String guncellenecekId, String hastaTcGuncelle, String doktorGuncelle, String bransGuncelle, String tarihGuncelle, String saatGuncelle) {
